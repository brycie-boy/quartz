...
Note: If that pain is avoidable, then to endure it without attempting to change it sounds like some kind of masochistic complacency. Nor does it sound courageous if your doing nothing to change it
