...
* Each time the child sees another instance of the letter *A*, the neurons representing the *common elements* are repeatedly activated, and become more strongly connected following Hebb’s law.
